...
<body>
			...
			<div class="container">
				<div class="alignR">
					<div class="pull-left socialNw">
						<a href="https://twitter.com/engadget"><span class="icon-twitter"></span></a> 
						<a href="https://www.facebook.com/Engadget"><span class="icon-facebook"></span></a> 
						<a href="https://www.youtube.com/c/Engadget"><span class="icon-youtube"></span></a> 					
					</div>
					<a class="active" href="<c:url value="/home" />"> <span class="icon-home"></span>
						Home
					</a> 					
					<c:if test="${not empty UserInfo }">						
						<a href="#"><span class="icon-user"></span> ${UserInfo.display_name }</a>
						<a href="<c:url value = "/logout"/>"><span class="icon-edit"></span> Logout </a> 
					</c:if>
					<c:if test="${empty UserInfo }">
						<a href="#"><span class="icon-user"></span> My Account</a>
						<a href="<c:url value = "/register"/>"><span class="icon-edit"></span>Login And Register  </a> 
					</c:if>										
					<a href="<c:url value = "/listCart"/>"><span class="icon-shopping-cart"></span> ${totalQuantyCart } Item(s) - 
	...
	<div class="copyright">
		<div class="container">
			...
			<span>Copyright &copy; 2022<br> The computer word
			</span>
		</div>
	</div>
